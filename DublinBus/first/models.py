...
class GpsNov(models.Model):
    ...
    jid = models.IntegerField(db_column='JID', blank=True, null=True)  # Field name made lowercase.
...
class MapStops(models.Model):
    ...
    stop_id = models.IntegerField(db_column='Stop_id', blank=True, null=True)  # Field name made lowercase.
    address = models.TextField(db_column='Address', blank=True, null=True)  # Field name made lowercase.
    location = models.TextField(db_column='Location', blank=True, null=True)  # Field name made lowercase.
    map_stop_id = models.AutoField(db_column='Map_stop_id', primary_key=True)  # Field name made lowercase.
